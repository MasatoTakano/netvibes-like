      ...
      <div v-if="show" class="modal-overlay">
        <div class="modal-content" role="dialog" aria-modal="true" :aria-labelledby="titleId">
          ...
          <header class="modal-header">
            ...
            <button @click="$emit('close')" class="modal-close-button" aria-label="Close modal">×</button>
          </header>
...
.modal-content {
  ...
  box-shadow: 0 5px 15px rgba(0,0,0,0.3); min-width: 450px;
...
.modal-body {
  padding: 20px 25px; overflow-y: auto; flex-grow: 1;
}
