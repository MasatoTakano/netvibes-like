...
<template>
  <BaseModal :show="show" title-id="memo-settings-title" @close="close">
    <template #title>{{ $t('memoSettings.title') }}</template>

    <template #default>
      <div v-if="widgetData" class="settings-form">
        <div class="form-group">
          <label :for="'memo-title-' + widgetData.id">{{
            $t('memoSettings.widgetTitle')
          }}</label>
          <input
        ...
        <div class="form-group">
          <label :for="'memo-font-family-' + widgetData.id">{{
            $t('common.font')
          }}</label>
          <select
        ...
        <div class="form-group">
          <label :for="'memo-font-size-' + widgetData.id">{{
            $t('common.fontSize')
          }}</label>
          <input
    ...
    (newData) => {
      if (newData) {
        ...
        editableSettings.fontFamily =
          newData.fontFamily || DEFAULT_NOTE_FONT_FAMILY;
